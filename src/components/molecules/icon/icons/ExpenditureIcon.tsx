...
interface ExpenditureIconProps {
  color?: string;
  width?: string | number;
  height?: string | number;
}

const ExpenditureIcon: React.FC<ExpenditureIconProps> = ({
  color = 'currentColor',
  width = 24,
  height = 24,
}) => {
  return (
    ...
    >
      <g transform="matrix(1.28514,0,0,1.28514,-2.23643,3.21126)">
        <path 
...
export default ExpenditureIcon;