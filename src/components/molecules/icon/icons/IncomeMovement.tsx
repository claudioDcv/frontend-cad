...
interface IncomeMovementIconProps {
  color?: string;
  width?: string | number;
  height?: string | number;
}

const IncomeMovementIcon: React.FC<IncomeMovementIconProps> = ({
  color = 'currentColor',
  width = 24,
  height = 24,
}) => {
  return (
    ...
    >
      <g transform="matrix(1,0,0,1,0.747661,0.100244)">
        <path 
...
export default IncomeMovementIcon;