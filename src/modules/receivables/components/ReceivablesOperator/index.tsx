...
const ReceivablesOperator = ({
  resolutionId,
  openNewReceivableForm,
  setOpenNewReceivableForm,
}: ReceivablesOperatorProps) => {
  ...
  const badInventoryTypes = filterInventoryType(
    inventoryTypes,
    ...
    <>
      ...
      <Box mt={2}>
        <Table
          ...
          columns={[
            ...
            },
            {
              ...
              label: 'Ver',
              render: (row) => (
                <IconButton onClick={() => setSelectedReceivable(row)}>
                  <Visibility />
                </IconButton>
              ),
            },
        ...
        <Box display="flex" justifyContent="flex-end" mt={2}>
          <Pagination {...receivables.meta} onChange={handleChangePage} />
        </Box>
      </Box>
      <Dialog
